...
import {
  LayoutDashboard, Users, Library, Video, MessageSquare, DollarSign,
      ...
      <aside className="w-60 bg-ink flex-shrink-0 flex flex-col">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-bold transition-colors relative ${
                    isActive ? "text-ink" : "text-white/55 hover:bg-white/5 hover:text-white"
                  }`
                }
        ...
        <div className="p-3 border-t border-white/10">
          <div className="flex items-center gap-2.5 px-3 py-2 mb-1">
            <div className="w-8 h-8 rounded-full flex items-center justify-center text-white font-black text-xs" style={{ background: brandColor }}>
